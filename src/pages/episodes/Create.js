                ...
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label for="series_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Episode name</label>
                                <input
                                    type="text"
                                    id="s_name"
                                    {...register("seriesName")}
                            ...
                            <div>
                                <label for="s_yt" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Episode YT ID</label>
                                <input
                                    type="text"
                                    id="s_yt"
                                    {...register("seriesYT")}
                            ...
                            <div>
                                <label for="s_dm" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Episode DM ID</label>
                                <input
                                    type="text"
                                    id="s_dm"
                                    {...register("seriesDM")}
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3">
                            <div>
                                <label for="s_trailer" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Episode Promo</label>
                                <input
                                    type="text"
                                    id="s_trailer"
                            ...
                            <div>
                                <label for="s_ost" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Episode Promo 2</label>
                                <input
                                    type="text"
                                    id="s_ost"
                                    {...register("seriesOST")}
                            ...
                            <div>
                                <label for="s_ost" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Episode Type</label>
                                <input
                                    type="text"
                                    id="s_ost"
                                    {...register("seriesType")}
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Series Type: yt|dm|cdn|web"
                                    required />
                            </div>
                        </div>
                        <div class="mb-6">
                            <label for="s_portraitImg" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Episode Cast</label>
                            <TagsInput
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3">
                            ...
                            <div class="mb-6">
                                <label for="s_genres" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Episode Genres</label>
                                <Select
                                    isMulti
