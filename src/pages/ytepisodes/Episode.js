...
const YTEpisode = () => {
    ...
    const onSubmit = () => {
        ...
        const response = axios.get(`https://node.aryzap.com/api/yt/get/${finalSeries.seriesYT}/${finalSeries._id}`).then((response) => {
        });
    ...
    const handleChangeSeries = (e) => {
        ...
        const response = axios.get(`https://node.aryzap.com/api/yt/${e.target.value}`)
            .then(res => {
    ...
    useEffect(() => {
        if (isLoading) {
            ...
            const response = axios.get('https://node.aryzap.com/api/yt/')
                .then(res => {
                ...
                {series ? series?.episode?.map((app, index) => {
                    return (
                        <div
                            ...
                            style={{
                                backgroundImage: `url(${app.status.privacyStatus == "public" ? app.snippet.thumbnails.medium.url : 'https://node.aryzap.com/public/'})`
                            }}>
