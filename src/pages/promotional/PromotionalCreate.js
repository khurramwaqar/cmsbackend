        ...
        try {
            const response = await axios.post('https://node.aryzap.com/api/media/pbupload', formData, {
                ...
                if (resp.data.imagePath != null) {
                    if (genreTitle != null) {
                        axios.post('https://node.aryzap.com/api/pb', {
                            title: genreTitle,
                            action: genreDesc,
                            ...
                            if (response.status === 200) {
                                alert("Your Genre has been successfully added");
                            }
    ...
    return (
        ...
        <>
            <div className="text-2xl font-bold pb-2 mb-5  border-b border-b-gray-500 ">
                Prommotional Banner <span className='font-extrabold'>{'>'}</span> Add and Prommotional Banner
            </div>

            <section class="bg-white dark:bg-gray-600">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add a new Prommotional Banner</h2>
                    <form action="#" onSubmit={handleSubmit} method='POST'>
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Prommotional Banner Name</label>
                                <input
                            ...
                            <div class="w-full">
                                <label for="bundle" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Prommotional Banner Image</label>
                                <input
                            ...
                            <div class="sm:col-span-2">
                                <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Action</label>
                                <textarea
